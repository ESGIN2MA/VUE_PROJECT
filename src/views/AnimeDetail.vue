        ...
        <div class="anime-body">
            ...
            <div class="anime-body-info">
                <div id="anime-trailer-yt" v-if="anime?.trailer.url != null">
                    <p><iframe width="560" height="315" :src="'https://www.youtube.com/embed/'+getIdFromLink(anime.trailer.url)" title="" frameBorder="0"   allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"  allowFullScreen></iframe></p>
                </div>
            </div>
